...
# hack to allow agent to go build
...
# add vim keybindings for terminal
set -o vi
...
alias gs="git status"
alias gl="git log"
alias gc="git commit -sS -v"
alias gll="git log --left-right --graph --cherry-pick --oneline --decorate"
...
alias cddot="cd $HOME/lwcode/src/nschmeller/dotfiles"
